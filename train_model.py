...
# Display your terminal logs as clean visual alerts
st.success(f"Saved {len(df):,} records to customer_accounts.csv")
st.info(f"Saved trained model to model.pkl")

# Highlight your final accuracy inside a clear metric card
